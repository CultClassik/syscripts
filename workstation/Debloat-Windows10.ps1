...
$features = $true # Set to true to enable removing and enabling features
$services = $true # Set to false to disable removing services
$schdtasks = $true # Set to false to disable OOTB scheduled tasks
$customize = $true # Set to true to enable customization tweaks
...
# ======================================================================================================= Main Code
<#
### Commented out by Chris Diehl so the functions can be used by calling script
